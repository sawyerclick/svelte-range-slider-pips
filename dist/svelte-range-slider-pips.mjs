...
function create_fragment$1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*orientationStart, $springPositions, activeHandle, range, ariaLabel, values, min, max, prefix, handleFormatter, percentOf, suffix, vertical, disabled, focus, handlePressed, float*/ 1869350109 | dirty[1] & /*sliderBlurHandle, sliderFocusHandle, sliderKeydown*/ 112) {
